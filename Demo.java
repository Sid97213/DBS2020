...
class Demo{
	...
	public static void main(String args[]){
		System.out.print("Enter the GD: ");
		Scanner sc = new Scanner(System.in);
		String input1 = sc.nextLine();
        int gd = Integer.parseInt(input1);	System.out.println(gd);
        System.out.print("Enter the BFR: ");
        String input2 = sc.nextLine();
        int bfr = Integer.parseInt(input2);	System.out.println(bfr);

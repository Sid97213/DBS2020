...
//        }
    ...
    public static List<String> nf2_normalisation(Relations r, String  key){ //requires the primary key to be passed as an argument for it to work properly
        List<String> fd_set = new ArrayList<>();  
        ...
        for(String l: rels){
            ...
            supplierNames1.add(t1 + " with its key being: " + keys.get(0));
        }
...
//                v.add(union);
                ...
                listString2=listString.substring(0, listString.length() - 1);
//                supplierNames3.add(listString2);
//                System.out.print("pls "+supplierNames3);
                System.out.print("\t");
                System.out.print("The key of this relation is: ");
//                supplierNames3.add("The key of this relation is: ");
//                v.add("The key of this relation is: ");
//                alpha.add('u');
...
//                    v.add(a);
                ...
                listString4=listString3.substring(0, listString3.length() - 1);
                supplierNames3.add(listString2 + " The key of this relation is: " + listString4);
...
//                    System.out.print(a);
                       list3.add(Character.toString(a));
//                    v.add(a);
                    }
...
//                v.add(union);
                    ...
                    listString6=listString5.substring(0, listString5.length() - 1);
//                    v.add(difference1);
//                    supplierNames3.add(difference1.toString());
//                    System.out.print("\t");
                    String s1=""; 
                    for(Character a: difference1){
                        s1=s1+a;
                    ...
                    supplierNames3.add(listString6 + " The key of this relation is: " + key_of_r2);
//                    System.out.print("The key of this relation is: ");
//                    v.add("The key of this relation is: ");
